...
keep vndlinsd vndlouts theft noise violence drugs dsrpothr 			/// 	/*Dependent Variables*/
	 omnttimu maintcur mainpcti omnttimu occlean ocrepair			/// 	/*Independent Variables*/
	 numprop ohowlong type id										   		/*Control Variables*/
...
recode dother (1 = 3 "Frequently") (2 3 = 1 "Never-Miss") (4/5 = 2 "Rarely-Occasionally"), gen (dother_r3)
